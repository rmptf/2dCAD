...
let bFooter_actions = [
    document.getElementById(aArtboardElementIdsArray[4]),
    document.getElementById(aArtboardElementIdsArray[5]),
    document.getElementById(aArtboardElementIdsArray[6]),
    document.getElementById(aArtboardElementIdsArray[7]),
    document.getElementById(aArtboardElementIdsArray[8]),
    document.getElementById(aArtboardElementIdsArray[9]),
]

let newCanvas = new Canvas(aCanvas_element, aCanvas_scale_element, aCanvas_pan_element)
new Footer(newCanvas.canvasElement, newCanvas.canvasDocuments, newCanvas.canvScaleClass, newCanvas.canvasPanClass, bFooter_element, bFooter_actions)

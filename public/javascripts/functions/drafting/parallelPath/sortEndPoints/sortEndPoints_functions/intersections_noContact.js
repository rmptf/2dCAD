...
function handlePathToArcIntersectionNoContact(self, pathToArcIntersectNoContactIndex, parallelFigure_data_pathDatasAndFillers_array_drawParallel, parallelPathDatas_stopAtPerpendicular_fromLOCAL, parallelPathDatas_stopAtIntersect_fromGLOBAL, originalFigure_counter_groupCount_GLOBAL) {
    console.log("titititititti")
    ...
    if(pathToArcIntPoint[0].doesIntersect === false) {
        ...
        a_canvas_globalVars.parallelFigure_data_pathDatas_array_GLOBAL[originalFigure_counter_groupCount_GLOBAL][a_canvas_globalVars.parallelFigure_counter_groupCount_GLOBAL].splice(thisIndex, 1)
...
function handleArcToPathIntersectionNoContact(self, pathToArcIntersectNoContactIndex, parallelFigure_data_pathDatasAndFillers_array_drawParallel, parallelPathDatas_stopAtPerpendicular_fromLOCAL, parallelPathDatas_stopAtIntersect_fromGLOBAL, originalFigure_counter_groupCount_GLOBAL) {
    let prevIndex = pathToArcIntersectNoContactIndex - 1
...
function handleArcToArcIntersectionNoContact(self, pathToArcIntersectNoContactIndex, parallelFigure_data_pathDatasAndFillers_array_drawParallel, parallelPathDatas_stopAtPerpendicular_fromLOCAL, parallelPathDatas_stopAtIntersect_fromGLOBAL, originalFigure_counter_groupCount_GLOBAL) {
    let prevIndex = pathToArcIntersectNoContactIndex - 1

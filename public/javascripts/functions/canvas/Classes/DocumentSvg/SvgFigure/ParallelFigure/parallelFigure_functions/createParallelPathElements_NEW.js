...
function createParallelPathElementsANDdatas_NEW(origFigurePathDatas) {
    ...
    for (let i = 0; i < origFigurePathDatas.length - 1; i++) {
            ...
            let thisOriginalFigurePathData = origFigurePathDatas[i]
            let nextOriginalFigurePathData = origFigurePathDatas[i + 1]
        ...
        return parallelFigurePathDatasGroup

...
function svg_expandSvgElementOnMouseMove_NEW(event, ThisFigure, CanvDoc, posData) {
    ...
    //     let thisCountCurrentPathDatas_x = posData[j].pathDataPos.x
    //     let thisCountCurrentPathDatas_y = posData[j].pathDataPos.y
    //     let svgDocLeftPos = posData[j].svgDocLeftPos
    //     let svgDocTopPos = posData[j].svgDocTopPos
    //     let svgDimensions = posData[j].svgDimensions


    //     let m2 = d3.pointer(event)
    //     let p1_x = allFigures[j].svgPathDatas.at(-2).coords.x
    //     let p1_y = allFigures[j].svgPathDatas.at(-2).coords.y
    ...
    //     // let distanceToTravel_x_left = m2[0]
    ...
    //     // let distanceToTravel_x_right = svgWidth - m2[0]
    ...
    //     // let distanceToTravel_y_up = m2[1]
    ...
    //     // let distanceToTravel_y_down = svgHeight - m2[1]
    ...
    //             let dragedPathDataIndex = allFigures[j].svgPathDatas.length - 1
    //             for (let i = 0; i < allFigures[j].svgPathDatas.length; i++) {
    //                 if(i !== dragedPathDataIndex) {
    //                     allFigures[j].svgPathDatas[i].coords.x = thisCountCurrentPathDatas_x[i] + movePathDatasThisAmount_x_left
    //                 }
    //             }
    //         }
    //     } else {
    ...
    //             for (let i = 0; i < allFigures[j].svgPathDatas.length; i++) {
    //                 if(i !== dragedPathDataIndex) {
    //                     allFigures[j].svgPathDatas[i].coords.y = thisCountCurrentPathDatas_y[i] + movePathDatasThisAmount_y_up
    //                 }
    //             }
    //         }
    //     } else {
...
function getElementPositionDataNEW(newFigure, CanvDoc) {
    ...
    //     let pathDataPosX = []
    //     let pathDataPosY = []
    //     allFigures[i].svgPathDatas.forEach(pathData => pathDataPosX.push(pathData.coords.x))
    //     allFigures[i].svgPathDatas.forEach(pathData => pathDataPosY.push(pathData.coords.y))
    ...
    //     allFigureData.push(data)
    // }
    // return allFigureData

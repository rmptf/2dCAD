var arc = {
  ...
  function update() {
    ...
    var d = getArcPath(arc.cx, arc.cy, arc.rx, arc.ry, arc.startAngle, 180);
    // var d = getArcPath(arc.cx, arc.cy, arc.rx, arc.rx, arc.startAngle, arc.sweepAngle);
    ...
    // arc.shape.setAttribute("ry", arc.rx);
  }
